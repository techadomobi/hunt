  ...
  return (
    <>
      ...
      <section className="bg-mercury-purple text-white py-20">
        ...
        >
          Hand-picked by our editorial team. Spin them all for free G현 no sign-up required.
        </motion.p>
      </section>
      ...
      <section className="bg-white py-24">
        <div className="container-mx">
          ...
          <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { i: ShieldCheck, t: "Independently verified", d: "Every casino is reviewed by our editorial team G현 never paid placements." },
        ...
        <div className="container-mx grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
              Every demo, every bonus, every casino review G현 perfectly responsive on any device.
        ...
        <div className="container-mx">
          ...
          <div className="mt-16 grid md:grid-cols-4 gap-8 relative">
            {[
              ...
              { n: "04", t: "Claim", d: "Activate the bonus that suits you G현 wagering, free spins, or cashback." },
            ].map((s, i) => (
              <motion.div
                key={s.n}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section className="bg-white py-24">
        <div className="container-mx">
          ...
          <p className="mt-5 text-center text-muted-foreground max-w-2xl mx-auto">
            Twelve hand-curated themed collections G현 pick a vibe, spin the matching reels.
          </p>
      ...
      <section className="bg-muted/40 py-24">
        <div className="container-mx">
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { t: "RTP", d: "Return to Player. The percentage of total wagered money a slot pays back over the long run G현 usually 94G혀97%." },
        ...
        <div className="container-mx grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
              ...
              our editorial team G현 never by an algorithm and never as a paid placement. We accept
      ...
      <section className="gradient-red text-white py-24 relative overflow-hidden">
        ...
        <div className="container-mx text-center relative">
          ...
          <p className="mt-4 text-white/85 max-w-2xl mx-auto text-lg">
            ...
            Or, if you're an operator G현 launch your own portal in under an hour.
          </p>
